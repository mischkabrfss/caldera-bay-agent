  ...
  return (
    <section className="section">
      <div className="wrap stack gap-14" style={{ maxWidth: 460 }}>
        ...
        <form method="post" action="/2m/api/auth/register" className="stack gap-14">
          ...
          <label className="check">
            ...
            <span>
              J’accepte les <Link href="/2m/conditions">conditions générales</Link> et je confirme
              être majeur.
            </span>
          </label>
        ...
        <p className="small center muted">
          Déjà inscrit ? <Link href="/2m/connexion">Se connecter</Link>
        </p>
      </div>
    </section>
  );
