          ...
          <div className="card-flat" style={{ background: 'rgba(0,0,0,0.35)', borderColor: 'rgba(240,197,60,0.28)' }}>
            ...
            <div className="between small muted mt-12">
              ...
              {main ? (
                ...
                <Link href="/2m/vip">Voir les VIP</Link>
              )}
            </div>
          </div>
        </div>
        ...
        <div className="wrap stack gap-14">
            ...
            {VIP_TYPES.map((type) => {
              ...
              return (
                <div key={type} className={`vip-row ${unlocked ? 'on' : ''}`}>
                  ...
                  {unlocked ? (
                    <Link href={`/2m/vip/${VIP_SLUGS[type]}`} className="btn btn-sm">
                      Ouvrir
                    </Link>
                  ) : (
                    <Link href={`/2m/vip#${offer.slug}`} className="btn-line btn-sm">
                      Débloquer
                    </Link>
                  )}
                </div>
          ...
          {stats ? (
            ...
            <div className="card-flat">
              ...
              <Link href="/2m/vip" className="btn btn-block mt-16">
                Choisir un VIP
              </Link>
            </div>
          )}
          ...
          {OFFERS.length && activeTypes.length < 3 ? (
            <Link href="/2m/vip" className="btn-line btn-block mt-8">
