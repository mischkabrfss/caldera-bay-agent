...
import { t as parseCookieHeader } from "./parse-cookie-BW6DLt1h.js";
import { d as hasBasePath, f as removeTrailingSlash, i as getLocalePathPrefix, l as splitPathSegments, p as stripBasePath, r as getDomainLocaleUrl, t as addLocalePrefix } from "./domain-locale-DjmvgscP.js";
import { a as toBrowserNavigationHref, c as fillRoutePatternSegments, f as routePatternParts, i as normalizePathTrailingSlash, l as matchRoutePattern, n as isAbsoluteOrProtocolRelativeUrl, o as toSameOriginAppPath, p as assertSafeNavigationUrl, r as isHashOnlyBrowserUrlChange, s as withBasePath, t as getWindowOrigin } from "./url-utils-5dfKQW-c.js";
import { a as getPagesRouterComponentsMap, c as resolvePagesDataNavigationTarget, d as fetchCachedPagesData, f as fetchStaticPagesData, i as markAppRouteDetectedOnPrefetch, l as dedupedPagesDataFetch, m as RouterContext, n as interpolateDynamicRouteHref, o as getPagesMiddlewareDataHref, p as getPagesStaticDataCache, s as prefetchPagesData, t as getCurrentBrowserLocale, u as evictPagesDataCache } from "./client-locale-DdMascRa.js";
import { t as isUnknownRecord } from "./record-Bf6Y90xa.js";
import { r as getDeploymentId, t as NEXT_DEPLOYMENT_ID_HEADER } from "./deployment-id-oZv1jJY-.js";
import { a as parseQueryString, i as mergeRouteParamsIntoQuery, n as appendSearchParamsToUrl, o as urlQueryToSearchParams, r as mergeRewriteQuery, t as addQueryParam } from "./query-B0wp76Le.js";
import { a as isExternalUrl, n as resolveDirectHybridClientRouteOwner } from "./hybrid-client-route-owner-direct-BHeI180d.js";
import { i as AppRouterContext, r as scrollToHashTarget, t as installWindowNext } from "./window-next-CulbZqM5.js";
//#region ../node_modules/.pnpm/vinext@1.0.0-beta.3_@vitejs+plugin-react@6.0.2_vite@8.0.13_@types+node@22.19.19_esbuild_9e27d51b024a659aca62537003146911/node_modules/vinext/dist/client/vinext-next-data.js
...
//#endregion
//#region ../node_modules/.pnpm/vinext@1.0.0-beta.3_@vitejs+plugin-react@6.0.2_vite@8.0.13_@types+node@22.19.19_esbuild_9e27d51b024a659aca62537003146911/node_modules/vinext/dist/client/validate-module-path.js
/**
...
//#endregion
//#region ../node_modules/.pnpm/vinext@1.0.0-beta.3_@vitejs+plugin-react@6.0.2_vite@8.0.13_@types+node@22.19.19_esbuild_9e27d51b024a659aca62537003146911/node_modules/vinext/dist/shims/pages-router-runtime.js
var pagesRouterPopStateHandler;
var stampInitialHistoryStateFn;
var pagesRouterRuntimeInstalled = false;
...
//#endregion
//#region ../node_modules/.pnpm/vinext@1.0.0-beta.3_@vitejs+plugin-react@6.0.2_vite@8.0.13_@types+node@22.19.19_esbuild_9e27d51b024a659aca62537003146911/node_modules/vinext/dist/shims/router.js
...
var __trailingSlash = process.env.__VINEXT_TRAILING_SLASH === "true";
/** experimental.scrollRestoration from next.config.js, injected by the plugin at build time */
var __scrollRestoration = process.env.__NEXT_SCROLL_RESTORATION === "true";
var noopCommit = () => {};
var SCROLL_RESTORE_MAX_FRAMES = 60;
var SCROLL_RESTORE_TOLERANCE_PX = 1;
/**
...
var PagesRouterCommitBoundary = class extends import_react.Component {
	componentDidCatch(error) {
		this.props.onError(error);
	}
	render() {
		return (0, import_react.createElement)(PagesRouterCommitBoundaryHelper, { onCommit: this.props.onCommit }, this.props.children);
	}
};
...
var manualScrollRestoration = __scrollRestoration && typeof window !== "undefined" && window.next?.appDir !== true && "scrollRestoration" in window.history && canUseSessionStorageForScrollRestoration();
...
var PAGES_ROUTER_RUNTIME_STATE_KEY = Symbol.for("vinext.pagesRouter.runtimeState");
...
var routerRuntimeState = getPagesRouterRuntimeState();
var routerEvents = routerRuntimeState.events;
...
var _ssrPagesNavCtxCache = /* @__PURE__ */ new WeakMap();
/**
...
var _cachedPagesRoutePatternKey = null;
var _cachedPagesRoutePattern;
...
async function resolveClientConfigRedirect(href) {
	...
	const { matchRedirect, preserveRedirectDestinationQuery } = await import("./config-matchers-C0OHN2Kd.js");
...
async function applyClientConfigRewrite(href, rewrite) {
	const routeContext = getClientConfigRouteContext(href);
	if (!routeContext) return null;
	const { matchRewrite } = await import("./config-matchers-C0OHN2Kd.js");
...
async function loadComponentOnlyProps(PageComponent, AppComponent, target, asPath) {
	...
	if (typeof AppComponent?.getInitialProps === "function") {
		const AppTree = (appProps) => (0, import_react.createElement)(AppComponent, {
			...appProps,
...
async function performNavigation(url, as, options, mode, onStateUpdate) {
	...
	const rewrites = window.__VINEXT_CLIENT_REWRITES__;
	const hybridOwner = rewrites && (rewrites.beforeFiles.length > 0 || rewrites.afterFiles.length > 0 || rewrites.fallback.length > 0) && hasClientAppRouteManifest() ? (await import("./hybrid-client-route-owner-CRqwJdSt.js")).resolveHybridClientRouteOwner(resolved, __basePath) : resolveDirectHybridClientRouteOwner(resolved, __basePath);
...
function PagesRouterProvider({ children }) {
	const [{ pathname, query, asPath, isReady }, setState] = (0, import_react.useState)(getRouterSnapshot);
	(0, import_react.useEffect)(() => {
		const onNavigate = ((_e) => {
	...
	const router = (0, import_react.useMemo)(() => buildRouterValue(pathname, query, asPath, isReady, {
	...
	const appRouter = (0, import_react.useMemo)(() => ({
		bfcacheId: "0",
		back() {
	...
	const content = (0, import_react.createElement)(RouterContext.Provider, { value: router }, (0, import_react.createElement)(import_react.Fragment, null, children, (0, import_react.createElement)(PagesRouterHydrationMarker)));
	return AppRouterContext ? (0, import_react.createElement)(AppRouterContext.Provider, { value: appRouter }, content) : content;
}
...
function wrapWithRouterContext(element, onCommit = noopCommit, onError = noopCommit) {
	...
	let inner = (0, import_react.createElement)(Provider, null, element);
	if (typeof window !== "undefined" && window.__VINEXT_REACT_STRICT_MODE__ === true) inner = (0, import_react.createElement)(import_react.StrictMode, null, inner);
	return (0, import_react.createElement)(CommitBoundary, {
		onCommit,
		onError
	}, inner);
}
...
var singletonRouter = Object.defineProperties(RouterMethods, {
	pathname: {
		enumerable: true,
		get() {
...
//#endregion
export { singletonRouter as default };

//# sourceMappingURL=router-D7UyeGw3.js.map