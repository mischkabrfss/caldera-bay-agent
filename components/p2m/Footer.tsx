    ...
    <footer className="p2m-footer">
      <div className="wrap stack gap-12">
        <div className="row gap-18" style={{ flexWrap: 'wrap' }}>
          <Link href="/2m/vip">Nos VIP</Link>
          <Link href="/2m/historique">Résultats</Link>
          <Link href="/2m/faq">FAQ</Link>
          <Link href="/2m/contact">Contact</Link>
          <Link href="/2m/conditions">Conditions générales</Link>
        </div>
        <p>
